...
export function createObjectRegistry() {
  return [
    ...
    { id: 'home-apron', location: 'home', kind: 'garment', name: 'diner apron', ratingLbs: 190, status: 'fine', history: [], slot: 'waist' },
    { id: 'home-couch', location: 'home', kind: 'chair', name: 'living-room couch', ratingLbs: 205, status: 'fine', history: [] },
    { id: 'home-scale', location: 'home', kind: 'object', name: 'bathroom scale', ratingLbs: 220, status: 'fine', history: [] },
